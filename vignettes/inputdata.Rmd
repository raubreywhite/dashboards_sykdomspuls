...
```{r}
print(sykdomspuls::VARS$REQ_DATA_RAW_STRUCTURAL)
```
...
```{r}
print(sykdomspuls::CONFIG$SYNDROMES)
print(sykdomspuls::VARS$REQ_DATA_RAW_OTHER)
```

In total, we require the following variables: 

```{r}
print(sykdomspuls::VARS$REQ_DATA_RAW)
```
