...
influensa_data <- reactive({
  ...
  data <- mem_schema$get_data_db(season==current_season, location==x_location)
  setDT(data)
  return(data)
})
...
output$influensa_plot <- renderPlot({
    ...
    q <- ggplot(data) +
      ...
      fhiplot::scale_fill_fhi("Level", labels=c("l1"="Svært lav", "l2"="Lav", "l3"="Middles",
                              "l4"="Høy", "l5"="Svært høy"),
