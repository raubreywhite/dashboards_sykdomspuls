...
AnalyseEmerg <- function(){
  fhi::RenderExternally(input=system.file("extdata/emerg.Rmd",package="sykdomspuls"),
                        output_file="stats.pdf",
                        output_dir=fhi::DashboardFolder("results", file.path(LatestRawID(),"emerg")),
                        params=sprintf("dev=%s,package_dir=\"%s\"",
                                       fhi::DashboardIsDev(),
                                       getwd()
                        ))
}
...
AnalyseStats <- function(){
  fhi::RenderExternally(input=system.file("extdata/stats.Rmd",package="sykdomspuls"),
                        output_file="stats.pdf",
...
AnalyseSkabb <- function(){
  fhi::RenderExternally(input=system.file("extdata/skabb.Rmd",package="sykdomspuls"),
                        output_file="stats.pdf",
